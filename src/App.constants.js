...
const SHARD_TYPES = [
  ...
  SECRET_TYPE.PASSWORD_SHARD_V2,
  SECRET_TYPE.SEED_PHRASE_SHARD_V2,
  SECRET_TYPE.CARD_SHARD_V2,
];

const SHARD_TYPES_V2 = [SECRET_TYPE.PASSWORD_SHARD_V2, SECRET_TYPE.SEED_PHRASE_SHARD_V2, SECRET_TYPE.CARD_SHARD_V2];
